...
console.log(Math.max(1,2,3,4,50)); // consolda 50 çıktısı alınır. max nuber tipinde dizi lazım en büyük değeri döner.
console.log(Math.min(10,0,5)); // consolda 0 çıktısı alınır. min nuber tipinde dizi lazım en küçük değeri döner.
